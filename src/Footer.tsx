...
const Header: React.FC = () => {
    return (
        <div className= "footer">
            ...
            <p className= "footerText">Powered by DunseithStudios</p>
        </div>
    )
}
